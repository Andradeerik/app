...
var word = [
    ["Ahorcado", "Ese juego estás jugando. Ahora mismo."],
    ["Daniel Andrade", "Sobre el creador de este juego."],
    ["HTML", "Lenguaje de marcado para crear páginas web."],
    ["CSS", "Lenguaje para stilos de página web"],
    ["PHP", "Un lenguaje de scripting de servidor muy popular."],
    ["JavaScript", "Hace que la página web sea dinámica sin volver a cargar la página web."],
    ["Java", "Ejecuta 15 mil millones de dispositivos. \ NUn programa puede ejecutarse en Windows, Linux y Mac."],
    ["SoloLearn", "Una compañía que todos pueden codificar para divertirse y compartir."],
    ["Love", "amor"],
    ["Document", "Una gran cantidad de texto en el archivo."],
    ["Patio de recreo", "Los niños de la escuela van a."],
    ["correr", "Usain bolt."],
    ["Código", "var hw = 'Hello World';"],
    ["Samsung", "Una empresa crea teléfono, televisión, monitor, SSD, chip de memoria ..."],
    ["Super Mario", "Un juego muy popular en Nintendo 64 que tiene sombrero rojo."],
    ["Estrella", "A Super Mario le gusta conseguir."],
    ["horas", "14:12 or 14pm"],
    ["Reloj binario", "Un reloj que solo usa 0 o 1.."],
    ["Espada", "Link de Zelda tienen en la mano."],
    ["Niña", "No niño?"],
    ["niño", "No niñl?"],
    ["mujer", "sexo opuesto de hombre."],
    ["espejo", "puedes ver tu reflejo."],
    ["Smartphone", "Algo que siempre has tenido en ti."],
    ["Diana", "chica muy bonita."]
]
